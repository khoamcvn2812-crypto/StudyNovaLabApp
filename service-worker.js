const CACHE_NAME = "novalab-pwa-v29";
const RUNTIME_CACHE = "novalab-runtime-v29";
const APP_SHELL = ["./","./index.html","./studynova_writing_vault.html","./studynova-auth.js","./studynova-realtime.js","./studynova-ai-coach.js","./studynova-ai-coach.css","./studynova-auth.css","./studynova-motion.css","./studynova-learning.css","./studynova-learning.js","./writing-drafts.js","./assets/icons/studynova-icons.svg","./assets/icons/studynova-icons.css","./assets/icons/studynova-icons.js","./assets/icons/index.html","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/apple-touch-icon.png"];
