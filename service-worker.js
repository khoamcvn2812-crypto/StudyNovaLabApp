const CACHE_NAME = "novalab-pwa-v12";
const RUNTIME_CACHE = "novalab-runtime-v12";
const APP_SHELL = ["./","./index.html","./studynova_writing_vault.html","./studynova-motion.css","./studynova-motion.js","./studynova-supabase.js","./writing-drafts.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/apple-touch-icon.png"];
