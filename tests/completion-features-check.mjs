...
check(sw.includes('studynova-platform-v32')&&sw.includes('./studynova-motion.css')&&sw.includes('./studynova-auth.css')&&sw.includes('./studynova-auth.js')&&sw.includes('./assets/icons/studynova-icons.svg'),'Service worker v32 shell is incomplete');
