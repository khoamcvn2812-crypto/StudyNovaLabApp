...
check(sw.includes('studynova-platform-v33')&&sw.includes('./studynova-motion.css')&&sw.includes('./studynova-auth.css')&&sw.includes('./studynova-auth.js')&&sw.includes('./assets/icons/studynova-icons.svg'),'Service worker v33 shell is incomplete');
