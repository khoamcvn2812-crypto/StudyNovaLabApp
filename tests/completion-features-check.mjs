...
check(sw.includes('novalab-pwa-v15')&&sw.includes('./studynova-motion.css')&&sw.includes('./studynova-auth.css')&&sw.includes('./studynova-auth.js'),'Service worker v15 shell is incomplete');
