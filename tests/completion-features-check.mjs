...
check(sw.includes('novalab-pwa-v18')&&sw.includes('./studynova-navigation.css')&&sw.includes('./studynova-navigation.js')&&sw.includes('./studynova-motion.css')&&sw.includes('./studynova-auth.css')&&sw.includes('./studynova-auth.js'),'Service worker v18 shell is incomplete');
