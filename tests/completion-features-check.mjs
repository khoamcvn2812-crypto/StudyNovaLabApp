...
check(sw.includes('novalab-pwa-v16')&&sw.includes('./studynova-motion.css')&&sw.includes('./studynova-auth.css')&&sw.includes('./studynova-auth.js'),'Service worker v16 shell is incomplete');
