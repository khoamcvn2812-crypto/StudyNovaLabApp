...
check(sw.includes('novalab-pwa-v23')&&sw.includes('./studynova-motion.css')&&sw.includes('./studynova-auth.css')&&sw.includes('./studynova-auth.js')&&sw.includes('./assets/icons/studynova-icons.svg'),'Service worker v23 shell is incomplete');
