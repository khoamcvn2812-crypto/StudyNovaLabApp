...
const worker=fs.readFileSync(new URL('../service-worker.js',import.meta.url),'utf8');if(!worker.includes('studynova-platform-v32')||!worker.includes('studynova-icons.svg'))throw new Error('Icon cache shell/version is stale');
